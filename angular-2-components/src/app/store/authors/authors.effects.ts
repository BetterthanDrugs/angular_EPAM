    ...
    return this.actions$.pipe(
      ...
      mergeMap(() =>
        this.authorService.getAll().pipe(
          ...
          catchError(() => of(AuthorsActions.requestAuthorsError()))
        )
      )
    );
  });
    ...
    return this.actions$.pipe(
      ...
      mergeMap(({ author }) =>
        this.authorService.addAuthor(author).pipe(
          ...
          catchError(() => of(AuthorsActions.requestAddAuthorError()))
        )
      )
    );
  });
    ...
    return this.actions$.pipe(
      ...
      mergeMap(({ author }) =>
        this.authorService.deleteAuthor(author).pipe(
          ...
          catchError(() => of(AuthorsActions.requestDeleteAuthorError()))
        )
      )
    );
  });
